...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  final _repetPassController = TextEditingController();
            ...
            return Form(
              ...
              child: ListView(
                ...
                children: <Widget>[
                  ...
                  SizedBox(height: 16.0,),
                  TextFormField(
                    controller: _repetPassController,
                    decoration: InputDecoration(
                    ...
                    child: RaisedButton(
                      ...
                      onPressed: (){
                        if(_formKey.currentState.validate()){
                          ...
                          if (_repetPassController.text != _passController.text){
                            _senhaDiferente();
                          }else{
  ...
  void _senhaDiferente(){
    _scaffoldKey.currentState.showSnackBar(
        SnackBar(content: Text("Senhas diferentes"),
